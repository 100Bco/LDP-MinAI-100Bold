...
function HeroSection({ y, opacity }: { y: any, opacity: any }) {
  return (
    <motion.section
      style={{ y, opacity }}
      className="relative flex flex-col items-center justify-center pt-10 pb-12 md:pt-20 md:pb-24 px-4 lg:px-12"
    >
      {/* Animated Streams into Center - REMOVED */}

      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between mb-8 md:mb-12 relative z-20 gap-6 md:gap-0">
        <motion.div
      ...
      <motion.div
        ...
        className="w-full max-w-7xl mx-auto mb-8 md:mb-16 relative z-20 overflow-hidden"
      >
        <p className="text-center text-slate-500 text-lg md:text-2xl font-bold mb-4 md:mb-8">
          OUR CUSTOMERS
        </p>
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-display font-bold leading-[1.1] tracking-tight mb-4 md:mb-8">
          <span className="block text-slate-900">INFRASTRUCTURE</span>

          {/* Animated Streams Between Text */}
          <div className="relative w-full h-[2px] my-2 md:my-6 bg-slate-100/50 overflow-hidden">
            <motion.div
        ...
        <p className="text-base md:text-2xl text-slate-500 font-light max-w-2xl mx-auto px-4">
  ...
  return (
    <section className="py-10 md:py-16 relative z-20">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          <div className="inline-flex items-center justify-center px-3 py-1 mb-4 md:mb-6 rounded-full border border-slate-200 bg-slate-50 text-slate-600 text-xs md:text-sm uppercase tracking-widest">
            The Core Concept
          </div>
          <h2 className="text-2xl md:text-5xl font-display font-bold text-slate-900">
...
function BreakdownSection() {
  ...
  return (
    <section className="py-6 md:py-12 relative z-20">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
          ...
          <motion.div
            ...
            className="group bg-white border border-slate-200 rounded-2xl md:rounded-3xl p-5 md:p-12 relative overflow-hidden transition-all duration-500 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/5"
          >
            {/* Visual background */}
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-blue-50 flex items-center justify-center mb-4 md:mb-8 border border-blue-100 group-hover:scale-110 transition-transform duration-500">
                <Cpu className="w-6 h-6 md:w-8 md:h-8 text-blue-600" />
              </div>

              <h2 className="text-2xl md:text-5xl font-display font-bold mb-1 md:mb-2 text-slate-900">MINAI</h2>
              <p className="text-base md:text-xl text-blue-600 font-medium mb-6 md:mb-10">Done-For-You AI Systems That Close Deals</p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="group bg-white border border-slate-200 rounded-2xl md:rounded-3xl p-5 md:p-12 relative overflow-hidden transition-all duration-500 hover:border-red-200 hover:shadow-xl hover:shadow-red-500/5"
          >
            {/* Visual background */}
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-red-50 flex items-center justify-center mb-4 md:mb-8 border border-red-100 group-hover:scale-110 transition-transform duration-500">
                <Video className="w-6 h-6 md:w-8 md:h-8 text-red-600" />
              </div>

              <h2 className="text-2xl md:text-5xl font-display font-bold mb-1 md:mb-2 text-slate-900">100BOLD</h2>
              <p className="text-base md:text-xl text-red-600 font-medium mb-6 md:mb-10">Start Brave. Stay Bold.</p>
...
function FiguresSection() {
  return (
    <section className="py-10 md:py-24 relative z-20 border-y border-slate-100 mt-6 md:mt-12 bg-slate-50/50">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 divide-x divide-slate-200/50 md:divide-x-0">
  ...
  return (
    <section className="py-12 md:py-24 relative z-20">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-2xl md:text-5xl font-display font-bold mb-2 md:mb-4 text-slate-900">See The Engines At Work</h2>
...
function CtaSection() {
  ...
  return (
    <section className="py-16 md:py-32 relative z-20 bg-white border-t border-slate-100 overflow-hidden">
      {/* Bottom glow */}
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl md:text-7xl font-display font-bold mb-2 md:mb-4 text-slate-900">Choose Your Engine.</h2>
          <p className="text-lg md:text-2xl text-slate-500 mb-8 md:mb-12 font-light">Or combine both.</p>

          <form onSubmit={handleSubscribe} className="max-w-md mx-auto mb-10 md:mb-16 relative">
          ...
          <div className="mt-12 md:mt-24 pt-6 md:pt-8 border-t border-slate-100">
